...
app.get('/businesses/search', (req, response) => {
	...
	let radius = 16093;
	var options = {
	  url: `https://api.yelp.com/v3/businesses/search?term=${req.query.term}&latitude=${req.query.latitude}&longitude=${req.query.longitude}&radius=${radius}`,
	  headers: {
	...
	request(options, (err, res, body) => {
		console.log('Made API call at: ' + options.url);
